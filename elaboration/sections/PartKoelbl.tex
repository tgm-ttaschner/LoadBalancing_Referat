...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=1\linewidth]{images/loadbalancing3.jpg}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=0.4\linewidth]{images/loadbalancing4.jpg}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=0.4\linewidth]{images/loadbalancing5.jpg}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=0.6\linewidth]{images/loadbalancing6.jpg}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{images/loadbalancing7.jpg}
		\caption{Layer 7 Load Balancing \cite{LoadBalancing2}}
		\label{Grafik}
	\end{center}
\end{figure}
...
\begin{figure}[!h]
	\begin{center}
		\includegraphics[width=0.8\linewidth]{images/loadbalancing9.jpg}
